  ...
  return (
    ...
    <p className={`${styles.sectionSubText} text-center hover:text-violet-600 animate-bounce cursor-pointer`}>Contact Us</p>
      <div className='flex justify-evenly p-6'>
        ...
        <a href="https://forms.gle/a6d1i4smGvZXQCjS7" target='_blank'><img src="https://cdn-icons-png.flaticon.com/128/2991/2991110.png" alt="Forms" className='w-14 h-14 hover:scale-125 ' /></a>
      </div>

      ...
      <div className={`${styles.paddingX} absolute inset-0 top-[120px] max-w-7xl mx-auto flex flex-row items-start gap-5`}>
        ...
        <div>
          ...
          <p className={`${styles.heroSubText} mt-2 text-white-100`}>
            ...
            <br className='sm:block hidden'/> TAM stands to be a knowledge-parting legacy from years! We are more than proud to introduce version 10 of TAM for the year 2023-24. Come and join us to be a part of the biggest intelligence-rave of St. Martin’s Engineering College.
          </p>
        </div>
